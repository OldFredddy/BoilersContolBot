...
public class ActualParams {
    ...
    public Float[] normalPvxHigh={0.42f, 0.45f, 0.45f, 0.45f, 0.2f, 6.0f, 0.45f, 0.44f, 0.45f, 0.45f, 0.45f, 0.5f};
    public Float[] normalPvxLow= {0.32f, 0.35f, 0.23f, 0.29f, 0.1f, 1.0f, 0.02f, 0.32f, 0.30f, 0.32f, 0.32f, 0.32f};
    private String wind;
